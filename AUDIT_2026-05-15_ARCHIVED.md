...
> [!warning] **ARCHIVED 2026-09-18.** This audit predates nearly every fix recorded since in
> `STATUS.md` (C-1, H-1, H-4, M-1, M-4, M-6, M-7, M-9, the v3.10 Starter Kit install, the
> hero-video work) and no longer reflects current reality. Kept for history only — see `AUDIT.md`
